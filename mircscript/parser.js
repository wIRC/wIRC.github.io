...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c55 = function(level, name, text, body) { return {type: 'Event', level: level, name: name, target: target, body: body} },
        ...
        peg$c179 = function(prop) {return {type: 'Identifier', name: chan, prop: prop, source: text()}; },
        peg$c180 = "%",
        peg$c181 = peg$literalExpectation("%", false),
        peg$c182 = function(name) { return {type: 'Variable', name: name}; },
        peg$c183 = "var",
        peg$c184 = peg$literalExpectation("var", true),
        peg$c185 = "=",
        peg$c186 = peg$literalExpectation("=", false),
        peg$c187 = function(name, value) { return  {type: 'VariableDeclaration', name: name, value: value && value[2], local: true}; },
        peg$c188 = "set",
        peg$c189 = peg$literalExpectation("set", true),
        peg$c190 = function(name, init) { return  {type: 'VariableDeclaration', name: name, value: value && value[2], local: false}; },
        peg$c191 = function(name, value) { return {type: 'VariableAssignment', name: name, value: value}; },
        peg$c192 = "inc",
        peg$c193 = peg$literalExpectation("inc", false),
        peg$c194 = function(name, inc) { return {type: 'VariableIncrement', name: name, inc: inc && inc[1]}; },
        peg$c195 = "dec",
        peg$c196 = peg$literalExpectation("dec", false),
        peg$c197 = function(name, dec) { return {type: 'VariableDecrement', name: name, dec: dec && dec[1]}; },
        peg$c198 = "$+",
